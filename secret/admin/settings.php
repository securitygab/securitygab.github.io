...
<div class="app-body">
                    ...
                    <div class="animated fadeIn">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input id="paypal" class="form-control" type="text" name="paypal"
                                       value="<?= $settings['paypal'] ?>">
                                <br>
                                <label for="purchase_status">Purchase Status</label>
                                <input id="purchase_status" class="form-control" type="text" name="purchase_status"
                                       value="<?= $settings['purchase_status'] ?>">
                                <br>
                                <label for="admin">Panel Password</label>
                                <input id="admin" class="form-control" type="text" name="admin"
                                       value="<?= $settings['admin'] ?>">
                            </div>
                            <div class="card-footer">
                                <button class="btn btn-info btn-block" onclick="submit()">Save</button>
                            </div>
                        </div>
    ...
    <script>
        ...
        function submit() {
            ...
            $.post('/admin/settings/update?access=<?= $_GET['access'] ?>', {
                paypal: $('#paypal').val(),
